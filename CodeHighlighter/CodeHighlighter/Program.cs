...
namespace CodeHighlighter
{
    class Program
    {
        private static readonly TelegramBotClient Bot = new TelegramBotClient("393926966:AAG158H_fhtctWo97uTB8R0ZQIgQDdq02Zc");
        ...
        private static async void BotOnCallbackQueryReceived(object sender, CallbackQueryEventArgs callbackQueryEventArgs)
        {
            ...
            if (answer == "Cancel")
            {
                ...
                if (!cancelled[username])
                {
                    ...
                    await Bot.SendTextMessageAsync(callbackQueryEventArgs.CallbackQuery.Message.Chat.Id, "Ok, your task has been canceled");
                }
            }
            else
            {
